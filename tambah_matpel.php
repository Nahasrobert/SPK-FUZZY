<?php
    ...
    $result = mysqli_query($conn, "INSERT INTO matpel(nama_matpel) VALUES('$nama_matpel')");

    // Check for errors in the query
    if($result) {
        // If successful, redirect to view_siswa.php
        header("Location: view_matpel.php?success=1");
    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Form Tambah Data Matapelajaran </h2>
                    ...
                    <div class="x_content">
                        <br />
                        <form method="post" action="tambah_matpel.php" name="form1" data-parsley-validate
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <input type="text" id="first-name" name="nama_matpel" required="required"
                                        class="form-control ">
                                    <br>
