...
if (isset($_SESSION["username"])) {
    // Ambil nilai sesi username
    $username = $_SESSION["username"];
} else {
    // Atau lakukan tindakan lain jika sesi username belum diatur
            ...
            <div class="col-md-3 left_col">
                <div class="left_col scroll-view">
                    <div class="navbar nav_title" style="border: 0;">
                        <a href="index.php" class="site_title"><i class="fa fa-calculator"></i> <span>SPK
                                FUZZY</span></a>
                    </div>
                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                ...
                                <li><a href="view_siswa.php"><i class="fa fa-users"></i> Data Siswa </a>
                                </li>
                                <li><a href="view_matpel.php"><i class="fa fa-list-alt"></i> Data Mata Pelajaran </a>
                                </li>

                                <li><a href="view_admin.php"><i class="fa fa-list-alt"></i> Data Admin </a>
                                </li>
