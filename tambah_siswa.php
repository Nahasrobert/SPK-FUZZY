<?php
    ...
    $result = mysqli_query($conn, "INSERT INTO siswa(nama_siswa, nis) VALUES('$nama_siswa', '$nis')");

    // Check for errors in the query
    if($result) {
        // If successful, redirect to view_siswa.php
        header("Location: view_siswa.php?success=1");
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br />
                        <form method="post" action="tambah_siswa.php" name="form1" data-parsley-validate
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <input type="number" id="first-name" name="nis" required="required"
                                        class="form-control ">
                                    <br>
                                    ...
                                    <input type="text" id="last-name" name="nama_siswa" required="required"
                                        class="form-control">
                                    <br>
