...
$result = mysqli_query($conn, "SELECT * FROM admin ORDER BY id_admin DESC");
?>
                    ...
                    <div class="x_title">
                        ...
                        <ul class="nav navbar-right panel_toolbox">
                            <li class="dropdown">
                                ...
                                <a class="dropdown-item" href="tambah_admin.php"><i class="fa fa-plus"></i>
                                    Tambah</a>
                            </li>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-info btn-sm"
                                                        href='ubah_admin.php?id=<?php echo $user_data['id_admin']; ?>'><i
                                                            class="fa fa-edit"></i></a>

                                                    <a class="btn btn-danger btn-sm"
                                                        onclick="return confirm('Apa yakin ingin menghapus data ini?')"
                                                        href='del_admin.php?id=<?php echo $user_data['id_admin']; ?>'><i
